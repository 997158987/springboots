...
<table class="table table-bordered" style="width: 900px;margin-top: 50px" align="center">
    ...
    <c:forEach items="${books}" var="book">
        <tr>
            ...
            <th><button type="button" class="btn btn-warning"  data-toggle="popover" data-trigger="focus" title="提示" data-content="已成功添加至收藏栏" onclick="favourite(${book.book_id})">收藏</button></th>
        </tr>
    </c:forEach>
</table>
